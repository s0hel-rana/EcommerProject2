...
@section('admin_content')
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <form method="post" action="{{route('save.brand')}}" class="form-horizontal">
                @csrf
                    <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="date01">Brand Name</label>
                        <div class="controls">
                        <input type="text" class="input-xlarge" id="date01" name="brand_name" required>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <textarea class="cleditor" id="textarea2" name="brand_description" rows="3" required></textarea>
                        </div>
                    </div>          
