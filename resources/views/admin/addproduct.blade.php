    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon edit"></i><span class="break"></span>AddProduct</h2>
                <div class="box-icon">
            ...
            <form method="post" action="{{route('save.product')}}" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                    <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <textarea class="cleditor" id="textarea2" name="product_description" rows="3" required></textarea>
                        </div>
                    </div>
                     <div class="control-group">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                        <input type="file" class="input-xlarge" id="date01" name="product_image" required>
                        </div>
                    </div>
                     <div class="control-group">
