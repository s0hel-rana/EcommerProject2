							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="{{route('view.product',$item->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="{{route('view.product',$item->product_id)}}"><i class="fa fa-plus-square"></i>{{$item->brand_name}}</a></li>
										<li><a href="{{route('view.product',$item->product_id)}}"><i class="fa fa-plus-square"></i>View Details</a></li>
									</ul>
								</div>
							</div>
						</div>
